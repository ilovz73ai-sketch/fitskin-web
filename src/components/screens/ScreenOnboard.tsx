  ...
  return (
    <div className="fs-app fs-fade-in" style={{ background: '#FAF7F2', minHeight: '100%', position: 'relative', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ position: 'relative', marginTop: 'auto', padding: '20px 24px 56px' }}>
        <button className="fs-btn fs-btn-block" onClick={onStart} style={{ height: 54, fontSize: 15, background: '#FEE500', color: '#191600' }}>
          <svg width="18" height="18" viewBox="0 0 24 24" fill="#191600"><path d="M12 3C6.48 3 2 6.48 2 11c0 2.52 1.5 4.78 3.84 6.27L4.5 21l4-2.4c1.12.27 2.3.4 3.5.4 5.52 0 10-3.48 10-8s-4.48-8-10-8z"/></svg>
          <span>카카오로 시작하기</span>
        </button>
        <div style={{ display: 'flex', gap: 8, marginTop: 10 }}>
          <button className="fs-btn fs-btn-ghost" style={{ flex: 1, height: 46, fontSize: 13, gap: 6, padding: '0 12px' }}>
            <svg width="14" height="14" viewBox="0 0 24 24"><path fill="#4285F4" d="M22.5 12.3c0-.8-.1-1.5-.2-2.2H12v4.2h5.9c-.3 1.4-1 2.5-2.2 3.3v2.7h3.5c2-1.9 3.3-4.7 3.3-8z"/><path fill="#34A853" d="M12 23c3 0 5.5-1 7.3-2.7l-3.5-2.7c-1 .7-2.2 1.1-3.8 1.1-2.9 0-5.4-2-6.3-4.6H2.1v2.8C3.9 20.5 7.6 23 12 23z"/><path fill="#FBBC05" d="M5.7 14.1c-.2-.7-.4-1.4-.4-2.1s.1-1.4.4-2.1V7.1H2.1A11 11 0 001 12c0 1.8.4 3.5 1.1 4.9l3.6-2.8z"/><path fill="#EA4335" d="M12 5.4c1.6 0 3.1.6 4.2 1.6l3.1-3.1C17.5 2.1 15 1 12 1 7.6 1 3.9 3.5 2.1 7.1l3.6 2.8C6.6 7.4 9.1 5.4 12 5.4z"/></svg>
            <span>Google</span>
          </button>
          <button className="fs-btn fs-btn-ghost" style={{ flex: 1, height: 46, fontSize: 13, gap: 6, padding: '0 12px' }}>
            <svg width="14" height="14" viewBox="0 0 24 24" fill="#1B1A17"><path d="M17.05 12.04c-.03-2.4 1.96-3.55 2.05-3.61-1.12-1.64-2.86-1.86-3.48-1.89-1.48-.15-2.9.87-3.65.87-.76 0-1.92-.85-3.16-.83-1.62.02-3.13.95-3.96 2.4-1.7 2.94-.43 7.27 1.21 9.65.8 1.16 1.76 2.46 3.01 2.42 1.21-.05 1.67-.78 3.13-.78 1.46 0 1.87.78 3.15.76 1.3-.02 2.13-1.18 2.92-2.35.93-1.34 1.31-2.65 1.33-2.72-.03-.01-2.55-.98-2.58-3.92zM14.66 4.84c.66-.81 1.11-1.92.99-3.04-.96.04-2.13.64-2.82 1.44-.61.71-1.16 1.86-1.02 2.95 1.07.08 2.18-.55 2.85-1.35z"/></svg>
            <span>Apple</span>
          </button>
        </div>
        <div className="fs-caption" style={{ textAlign: 'center', marginTop: 12, lineHeight: 1.5, fontSize: 11 }}>
